package DefiningClasses.Exercise.P08FamilyTree;

import java.util.*;

import static DefiningClasses.Exercise.P08FamilyTree.Person.findPerson;
import static DefiningClasses.Exercise.P08FamilyTree.Person.getFamilyTreeFor;
